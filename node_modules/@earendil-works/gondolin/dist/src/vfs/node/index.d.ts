...
export type VirtualFileHandle = {
    ...
    } | BufferEncoding): Promise<Buffer | string>;
...
export type VirtualProvider = {
    ...
    writeFile?(path: string, data: Buffer | string, options?: {
        encoding?: BufferEncoding;
        mode?: number;
    }): Promise<void>;
    writeFileSync?(path: string, data: Buffer | string, options?: {
        encoding?: BufferEncoding;
        mode?: number;
    }): void;
    appendFile?(path: string, data: Buffer | string, options?: {
        encoding?: BufferEncoding;
        mode?: number;
    }): Promise<void>;
    appendFileSync?(path: string, data: Buffer | string, options?: {
        encoding?: BufferEncoding;
        mode?: number;
    }): void;
...
export type VirtualFileSystem = {
    ...
    readonly promises: {
        ...
        symlink(target: string, path: string, type?: string): Promise<void>;
        access(path: string, mode?: number): Promise<void>;
        watch(path: string, options?: object): AsyncIterable<{
            eventType: string;
            filename: string;
        }>;
    };
...
declare const VirtualFileSystem: VirtualFileSystemConstructor;
declare const VirtualProvider: VirtualProviderConstructor;
declare const MemoryProvider: MemoryProviderConstructor;
declare const RealFSProvider: RealFSProviderConstructor;
declare function create(providerOrOptions?: VirtualProvider | object, options?: object): VirtualFileSystem;
